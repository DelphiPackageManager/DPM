...
begin
  ...
  case compiler of
    TCompilerVersion.DelphiXE2 : result := [TDPMPlatform.Win32, TDPMPlatform.Win64, TDPMPlatform.MacOS32];

    TCompilerVersion.DelphiXE3 : result := [TDPMPlatform.Win32, TDPMPlatform.Win64, TDPMPlatform.MacOS32];
