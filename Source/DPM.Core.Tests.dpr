...
uses
  ...
  DPM.Creator.TargetPlatform.Collapse in 'DSpecCreator\DPM.Creator.TargetPlatform.Collapse.pas',
  ...
  DPM.Core.Project.ConfigPatcher in 'Core\Project\DPM.Core.Project.ConfigPatcher.pas',
  ...
  DPM.Core.Tests.Crypto.Hashing in 'Tests\DPM.Core.Tests.Crypto.Hashing.pas',
  DPM.Core.Tests.Dependency.Resolver in 'Tests\DPM.Core.Tests.Dependency.Resolver.pas',
  DPM.Core.Tests.Package.Manifest in 'Tests\DPM.Core.Tests.Package.Manifest.pas',
  ...
  DPM.Core.Tests.Project.ConfigPatcher in 'Tests\DPM.Core.Tests.Project.ConfigPatcher.pas',
  DPM.Core.Tests.Project.Transformer in 'Tests\DPM.Core.Tests.Project.Transformer.pas',
  ...
  DPM.Core.Tests.Spec.Collapse in 'Tests\DPM.Core.Tests.Spec.Collapse.pas',
  DPM.Core.Tests.Spec.RoundTrip in 'Tests\DPM.Core.Tests.Spec.RoundTrip.pas',
  DPM.Core.Tests.Packaging.EnvironmentVariableValidator in 'Tests\DPM.Core.Tests.Packaging.EnvironmentVariableValidator.pas',
  ...
  DPM.Core.Tests.Package.Receipt in 'Tests\DPM.Core.Tests.Package.Receipt.pas',
